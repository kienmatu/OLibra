 ...
 * `/tu-sach/[shelf]/toi/tang-sach` as separate screens for the same act: a
 ...
 * happened to each — which puts it under `toi/` with the reader's other pages
...
export default async function DonationRedirect({
  ...
  redirect(`/tu-sach/${encodeURIComponent(shelf)}/toi/tang-sach`);
}
