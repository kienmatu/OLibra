...
const SECTIONS = [
  {
    title: "Cửa trước",
    blurb:
      "Toàn bộ những gì một người chưa có tài khoản nhìn thấy. Chỉ có bấy nhiêu.",
    routes: [
      [
        "/",
        "Trang chủ",
        "Logo, một hai câu, và hai lối vào: đăng nhập hoặc tìm tủ sách.",
      ],
      [
        "/tu-sach",
        "Tìm tủ sách",
        "Chỉ tên và địa chỉ. Tìm giáo xứ của mình để đăng ký.",
      ],
      [
        "/dang-ky",
        "Đăng ký bạn đọc",
        "Ảnh trước, tên cha mẹ bắt buộc, tên đăng nhập để trống cũng được.",
      ],
      [
        "/dang-nhap",
        "Đăng nhập",
        "Quên mật khẩu thì nhắn quản lý — hệ thống không gửi email.",
      ],
      ["/lien-he", "Liên hệ", "Dành cho người muốn mở một tủ sách mới."],
    ],
  },
  {
    title: "Trang tủ sách — sau khi đăng nhập",
    blurb:
      "Tủ sách không còn công khai. Bạn đọc phải là thành viên của chính tủ này mới xem được.",
    routes: [
      [
        S,
        "Trang tủ sách",
        "Nhận diện tủ sách trước tiên: ở đâu, mở khi nào, gọi ai.",
      ],
      [
        `${S}/danh-muc`,
        "Danh mục sách",
        "Lưới bìa sách; chuyển đang có / toàn bộ bằng nút gạt.",
      ],
      [
        `${S}/sach/de-men-phieu-luu-ky`,
        "Chi tiết sách — còn sách",
        "Bảng xanh, một nút Xin mượn, và lối tắt Cho mượn / Nhận trả cho quản lý.",
      ],
      [
        `${S}/sach/hoang-tu-be`,
        "Chi tiết sách — đang mượn",
        "Bảng hổ phách nêu ai đang giữ, còn mấy ngày, mấy người chờ.",
      ],
      [
        `${S}/tim-kiem?q=de+men`,
        "Tìm kiếm",
        "Không cần gõ dấu — 'de men' vẫn ra 'Dế Mèn'.",
      ],
      [
        `${S}/thong-bao`,
        "Thông báo",
        "Tin ghim hiện đầu trang, các tin còn lại xếp dưới.",
      ],
      [
        `${S}/gop-y`,
        "Gửi góp ý",
        "Biểu mẫu một cột; trường bắt buộc ghi rõ bằng chữ.",
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    routes: [
      [
        `${S}/quan-ly`,
        "Trang chính",
        "Bốn thẻ cần xử lý, rồi hai nút lớn: Cho mượn và Nhận trả.",
      ],
      [
        `${S}/quan-ly/cho-muon`,
        "Cho mượn · bước 1/3",
        "Tìm sách; ô tìm kiếm là thứ nổi bật nhất màn hình.",
      ],
      [
        `${S}/quan-ly/cho-muon/nguoi-doc`,
        "Cho mượn · bước 2/3",
        "Bạn đọc không mượn được vẫn hiện, kèm lý do rõ ràng.",
      ],
      [
        `${S}/quan-ly/cho-muon/xac-nhan`,
        "Cho mượn · bước 3/3",
        "Hạn trả ghi thành ngày, không phải giờ phút.",
      ],
      [
        `${S}/quan-ly/nhan-tra`,
        "Nhận trả",
        "Sáu nút tình trạng, 'Nguyên vẹn' chọn sẵn — ca thường gặp chỉ một chạm.",
      ],
      [
        `${S}/quan-ly/qua-han`,
        "Quá hạn",
        "Số điện thoại là nút gọi — cách sách quay về nhanh nhất.",
      ],
      [
        `${S}/quan-ly/dang-ky-cho-duyet`,
        "Đăng ký chờ duyệt",
        "Có cảnh báo trùng tên để bắt đăng ký lặp.",
      ],
      [
        `${S}/quan-ly/doi-thong-tin`,
        "Đổi thông tin chờ duyệt",
        "Giá trị cũ và mới đặt cạnh nhau; số cũ vẫn dùng được tới khi duyệt.",
      ],
      [
        `${S}/quan-ly/yeu-cau-muon`,
        "Yêu cầu mượn",
        "Xếp theo sách và thứ tự đăng ký; giữ chỗ do quản lý quyết định.",
      ],
      [
        `${S}/quan-ly/binh-luan`,
        "Bình luận chờ duyệt",
        "Bình luận chỉ hiện công khai sau khi được duyệt.",
      ],
      [
        `${S}/quan-ly/sach`,
        "Danh sách sách",
        "Bảng trên máy tính, thẻ xếp dọc trên điện thoại.",
      ],
      [
        `${S}/quan-ly/sach/moi`,
        "Thêm sách",
        "Ảnh bìa trước tiên; hệ thống tự sinh mã cho từng bản.",
      ],
      [
        `${S}/quan-ly/sach/de-men-phieu-luu-ky`,
        "Chi tiết sách (quản lý)",
        "Từng bản sách, lịch sử đánh giá tình trạng và lịch sử mượn.",
      ],
      [
        `${S}/quan-ly/nguoi-doc`,
        "Danh sách bạn đọc",
        "Lọc theo trạng thái bằng thẻ, không dùng danh sách xổ.",
      ],
      [
        `${S}/quan-ly/nguoi-doc/moi`,
        "Đăng ký hộ",
        "Quản lý điền thay em nhỏ — vẫn vào hàng chờ duyệt.",
      ],
      [
        `${S}/quan-ly/nguoi-doc/minh`,
        "Hồ sơ bạn đọc",
        "Có trường chỉ quản lý thấy; tạm khoá không ảnh hưởng sách đang mượn.",
      ],
      [
        `${S}/quan-ly/thong-ke`,
        "Thống kê",
        "Chỉ biểu đồ cột và đường; mỗi biểu đồ có câu tóm tắt phía trên.",
      ],
      [
        `${S}/quan-ly/thong-bao`,
        "Thông báo",
        "Viết, ghim, đăng và cho hết hạn thông báo của tủ sách.",
      ],
      [
        `${S}/quan-ly/cai-dat`,
        "Cài đặt",
        "Quy định cho mượn chỉ đọc, kèm nút xuất dữ liệu CSV.",
      ],
    ],
  },
  {
    ...
    routes: [
      [
        "/quan-tri",
        "Tổng quan",
        "Mỗi tủ sách một dòng; việc cần chú ý viết thành câu tiếng Việt.",
      ],
      [
        "/quan-tri/tu-sach",
        "Cài đặt tủ sách",
        "Đường dẫn khoá sau khi tạo, vì đã nằm trong link đã chia sẻ.",
      ],
      [
        "/quan-tri/quan-ly-vien",
        "Quản lý viên",
        "Thu hồi quyền đổi vai trò, không bao giờ xoá người.",
      ],
      [
        "/quan-tri/quan-ly-vien/lan",
        "Hoạt động của quản lý viên",
        "Trả lời câu hỏi: quản lý này đã làm những gì.",
      ],
      [
        "/quan-tri/nhat-ky",
        "Nhật ký",
        "Mỗi dòng là một câu tiếng Việt; giá trị gốc chỉ hiện khi mở rộng.",
      ],
      [
        "/quan-tri/gop-y",
        "Hộp thư góp ý",
        "Trả lời bằng cách gọi điện, vì hệ thống không gửi email.",
      ],
      [
        "/quan-tri/cai-dat",
        "Cài đặt hệ thống",
        "Mặc định cho tủ sách mới, ngôn ngữ và múi giờ.",
      ],
    ],
  },
  {
    ...
    routes: [
      [
        ...
        "Giọng nhẹ nhàng; biểu tượng màu xám ấm chứ không phải đỏ.",
      ],
      [
        "/loi",
        "Các trạng thái lỗi khác",
        "403, hết phiên đăng nhập, quá nhiều yêu cầu, lỗi máy chủ.",
      ],
    ],
  },
];
...
const MOBILE = {
  ...
  blurb:
    "Tình nguyện viên đứng ngay tại kệ sách, chỉ có một chiếc điện thoại trên tay.",
  routes: [
    ...
    [
      `${S}/sach/de-men-phieu-luu-ky`,
      "Chi tiết sách",
      "Tựa sách và nút mượn lên trước, thông tin tra cứu xuống cuối.",
    ],
    [
      `${S}/quan-ly`,
      "Trang chính (quản lý)",
      "Bốn thẻ 2×2 và hai nút lớn cỡ ngón tay cái.",
    ],
    [
      `${S}/quan-ly/cho-muon`,
      "Cho mượn",
...
await page.goto("file://" + resolve(indexPath), {
  waitUntil: "load",
  timeout: 180000,
});
